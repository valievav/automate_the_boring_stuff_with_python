...
passwords.append(valid_pass(8))
passwords.append(valid_pass(11))
passwords.append(invalid_pass_lower_letter_digit(3))
passwords.append(invalid_pass_upper_letter_digit(8))
passwords.append(invalid_pass_no_digit(9))
